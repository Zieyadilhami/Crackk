...
Facebook  = 'Facebook.com/Muhammad Amir'
Whatsapp  = '083852886840'
YouTube   = 'https://youtube.com/c/MhdAmir'
Version   = '0.6'
...
def poster3():
    ...
    l6 = ('     %s Multi Brute Force Facebook %s%s %sBy %sAmir     '%(P,B,Version,P,B))
    print('%s\n%s\n%s\n%s\n%s\n%s'%(l1,l2,l3,l4,l5,l6))
